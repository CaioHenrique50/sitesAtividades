...
<html lang = "pt-br">
	...
	<body>
		...
		<section class="tudo_user">
			<form method="post" name="formCadAdm" action="">
				<br>
				<span>Usuario:</span>
				...
				<input type="submit" name="Confirmar" value="Confirmar" id="enviar" onclick="return validarLogin()">
			</form>
		</section>
		<footer>
		<footer>
...
if (isset($_POST["Confirmar"])) {
	$usuario->setNome_adm($_POST['nome']);
	$usuario->setEmail($_POST['email']);
	$usuario->setSenha($_POST['senha']);
	if($admDAO->cadastrar($usuario)){

		echo "<script>alert('Cadastrado com sucesso');</script>";
	}else{
		echo "<script>alert('erro no Cadastro! Informe a equipe de desenvolvimento!');</script>";
	}
